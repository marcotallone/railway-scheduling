from railway import *
import pandas as pd
from others import optimization0
...
# Solve same problem with optimization 0
TEST_FILENAME = f"datasets/test_N{N}_J{J}_T{T}.txt"
(
    status0,
    runtime0,
    heuristics_time0,
    ...
    nodes0,
    iterations0
) = optimization0(TEST_FILENAME, timelimit)
